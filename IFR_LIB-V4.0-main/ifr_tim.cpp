...
IFR_TIM_ClassDef* TIM_Pointer[15] = {0};//定时器类指针，用于定向查找任务函数
/**
  * @概述	开启定时器溢出中断。
  * @参数1	定时器句柄
  * @返回值 void
...
{
	if(TIM_Overflow_Function!= NULL) (*TIM_Overflow_Function)();
}
//中断回调函数，禁止改写和调用!!!
